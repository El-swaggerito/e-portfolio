...
const Home = () => {
  return (
    <div
      name="home"
      id="Home"
      className="h-screen w-full min-h-screen bg-gradient-to-b from-black via-black to-gray-800 pb-40 sm:pb-0"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        ...
        <div>
          <img
            src={profilePic}
            alt="my profile"
            className="rounded-2xl mx-auto w-2/3 md:w-full max-w-xl max-sm:hidden"
          />
        </div>
      </div>
    </div>
